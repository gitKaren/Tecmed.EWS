...
namespace EWS.Domain.Data
{
    ...
    /// </summary>
    public interface IEntityWriter : IUnitOfWork, IEntityReader
    {
        /// <summary>
        ...
        TEntity Get<TEntity>(object firstKeyValue, params object[] otherKeyValues) where TEntity : DbEntity;
        ...
        /// store.</returns>
        IQueryable<TEntity> Get<TEntity>() where TEntity : DbEntity;
        ...
        void Create<TEntity>(TEntity entity) where TEntity : DbEntity;
        ...
        void Delete<TEntity>(TEntity entity) where TEntity : DbEntity;
        ...
        void Update<TEntity>(TEntity entity) where TEntity : DbEntity;
        ...
        void Reload<TEntity>(TEntity entity) where TEntity : DbEntity;
    }
}
